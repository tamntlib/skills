---
name: translator
description: Translate from one source language into one or more target languages with stable glossary mapping for proper nouns and special terms. Use this skill whenever the user asks for translation, bilingual or multilingual copy adaptation, glossary harmonization, or wants names, brands, teams, products, projects, place names, or explicit special terms translated the same way across repeated requests. Also use it when the user asks to remember preferred translations for future multilingual work.
...
3. after translating, persist it in `./translator-glossary.tsv`
...
- avoid duplicate rows for the same glossary item
